...
from backend.src.db.models import Answer
...
class AnswerService:
    ...
    def create_answer(self, submission_id: str, question_id: str, content: str, is_correct: bool):
        try:
            answer = Answer(
    ...
    def update_answer(self, answer_id: str, **kwargs):
        try:
